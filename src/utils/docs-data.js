...
export const HELP_DATA = {
    ...
    docker: "docker run -d -p 3000:3000 -v \"$(pwd)/configs:/app/configs\" -v \"$(pwd)/plugins:/app/plugins-user\" -e USER_PLUGINS_DIR=/app/plugins-user justlikemaki/aiclient-2-api"
};
