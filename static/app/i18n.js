...
const translations = {
    'zh-CN': {
        ...
        'oauth.ob1.batchImportDesc': '批量导入 refresh_token 或完整账号 JSON',
        'oauth.ob1.tokensPlaceholder': '每行一个 refresh_token，或粘贴 JSON 数组/对象',
        'oauth.ob1.importInstructions': '支持 refresh_token 字符串列表，或包含 access_token/refresh_token 的 JSON 对象/数组。',
    ...
    'en-US': {
        ...
        'oauth.ob1.batchImportDesc': 'Import refresh_token strings or full account JSON',
        'oauth.ob1.tokensPlaceholder': 'One refresh_token per line, or paste JSON array/object',
        'oauth.ob1.importInstructions': 'Supports refresh_token lines or JSON objects/arrays with access_token and refresh_token.',
