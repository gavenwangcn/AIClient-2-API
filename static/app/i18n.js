...
const translations = {
    'zh-CN': {
        ...
        'oauth.modal.callbackHostHint': '通过 IP 访问时填写服务器 IP，确保 Google 回调能到达本服务',
    ...
    'en-US': {
        ...
        'oauth.modal.callbackHostHint': 'When accessing via IP, enter server IP so Google can redirect back to this service',
