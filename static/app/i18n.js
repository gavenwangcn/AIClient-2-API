...
const translations = {
    'zh-CN': {
        ...
        'dashboard.routing.mcpSectionCurl': '经本服务 HTTP（curl）',
        'dashboard.routing.mcpSectionDocker': '容器内 mcporter（与 OAuth 自检相同）',
        'dashboard.routing.mcpDockerHint': '将容器名 aiclient2api、配置路径换成你的环境；非 Docker 时在安装 mcporter 的机器上改用本机 mcporter.json 路径。',
    ...
    'en-US': {
        ...
        'dashboard.routing.mcpSectionCurl': 'HTTP via this service (curl)',
        'dashboard.routing.mcpSectionDocker': 'mcporter inside container (same as OAuth verify)',
        'dashboard.routing.mcpDockerHint': 'Replace container name aiclient2api and config paths for your setup; without Docker, run mcporter on the host with your local mcporter.json path.',
